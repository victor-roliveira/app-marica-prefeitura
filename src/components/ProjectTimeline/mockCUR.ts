...
export const curvaMock: ProjectTimelineData = {
    ...
    progress: [
        ...
        { project_id: "CUR02", step_id: "ET07", advance_percent: 30, step_start_date: "2026-10-01", step_end_date: "2027-02-01", show_percent: true, completed: false },
        { project_id: "CUR02", step_id: "ET08", advance_percent: 65, step_start_date: "2027-02-01", step_end_date: "2027-10-02", show_percent: true, completed: false },
        { project_id: "CUR02", step_id: "ET09", advance_percent: 20, step_start_date: "2026-01-15", step_end_date: "2026-10-01", show_percent: true, completed: false },
        { project_id: "CUR02", step_id: "ET10", advance_percent: 20, step_start_date: "2026-01-15", step_end_date: "2026-10-01", show_percent: true, completed: false },
    ],
